      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-center">
            ...
            <p>
              Email:{" "}
              <a
                href="mailto:contact@succedomortgage.com"
                className="footer-email"
              >
                contact@succedomortgage.com
              </a>
            </p>
          </div>
        ...
        <div className="footer-bottom">
          <p>
            ...
            AT WWW.SML.TEXAS.GOV. A TOLL-FREE CONSUMER HOTLINE IS AVAILABLE AT
            ...
            RECOVERY FUND MUST BE FILED WITH AND INVESTIGATED BY THE DEPARTMENT
            PRIOR TO THE PAYMENT OF A CLAIM. FOR MORE INFORMATION ABOUT THE
            RECOVERY FUND, PLEASE CONSULT THE DEPARTMENT’S WEBSITE AT
            <span> </span><a href="http://www.sml.texas.gov" className="footer-link">WWW.SML.TEXAS.GOV.</a>
          </p>
          <p>
            &copy; 2024 Succedo Mortgage, LLC NMLS: 2584954 Licensed In: Texas
            and Colorado
          </p>
        </div>
      </div>
